...
mod mmio;
pub use mmio::{VcpuMmioDirection, VcpuMmioExit};
...
mod tests {
    ...
    #[test]
    fn classifies_kvm_unknown_hlt_io_mmio_shutdown_fail_entry_internal_error_system_event_and_preserves_other_unhandled_reason(
    ) {
        assert_eq!(
