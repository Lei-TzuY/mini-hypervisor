...
use mini_hypervisor::syscall::dispatcher::{
    ...
    DISPATCH_COPY_READ_FIXUP_RIP, DISPATCH_COPY_WRITE_FAULT_RIP,
    DISPATCH_COPY_WRITE_FIXUP_RIP, DISPATCH_EFAULT, DISPATCH_ENOSYS,
    DISPATCH_PROOF, DISPATCH_READ_FAULT_OBSERVATION_ADDR, DISPATCH_TERMINAL_HLT_RIP,
    DISPATCH_TERMINAL_RETURN_RIP, DISPATCH_VALUE, DISPATCH_WRITE_FAULT_OBSERVATION_ADDR,
};
